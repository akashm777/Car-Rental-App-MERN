    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
        ...
        text-sm mt-6 max-w-xl'>
            ...
            <div className='flex flex-col w-full'>
                ...
                <textarea rows={5} placeholder="e.g. A luxurious SUV with a spacious interior and a powerful engine." required className='px-3 py-2 mt-1 border
                border-borderColor rounded-md outline-none'value={car.description} 
